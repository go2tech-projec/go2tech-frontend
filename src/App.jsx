    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-6">
          <h1 className="text-3xl font-bold text-gray-800">GO2TECH</h1>
          <p className="text-gray-600 mt-1">Transcript Analysis - Tech Job Platform</p>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="space-y-8">
          ...
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Upload Your Transcript</h2>
